...
public class GameManager : MonoBehaviour
{
    ...
    private void Update()
    {
        // set achievement gold
        string b = Convert.ToString(TotalGold);
        AchievementController.Instance.UnlockAchievement(AchievementType.ReachGold, b);
